      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          >
            ...
            <img
              src="/logo.png"
              alt="BloodBound SMP Logo"
              className="h-8 w-auto object-contain transition-transform group-hover:scale-105 drop-shadow-[0_0_10px_rgba(220,38,38,0.5)]"
            />
            <span
              className="text-xl font-black tracking-tighter hover:opacity-90 transition-opacity hidden sm:inline-block"
              style={{ textShadow: "0 0 20px rgba(220,38,38,0.5)" }}
            >
              <span className="text-red-600">BLOOD</span>
              <span className="text-white">BOUND</span>
              <span className="text-gray-500 text-sm ml-1">SMP</span>
            </span>
          </Link>
